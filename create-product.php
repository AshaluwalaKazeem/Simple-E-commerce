...
if ($_POST) {
  ...
  if (isset($_POST["submit"])) {
    ...
    if ($check3 !== false) {
      ...
      // Allow certain file formats
      if (
        $imageFileType_three != "jpg" && $imageFileType_three != "png" && $imageFileType_three != "jpeg"
    ...
    if ($check4 !== false) {
      ...
      // Allow certain file formats
      if (
        $imageFileType_four != "jpg" && $imageFileType_four != "png" && $imageFileType_four != "jpeg"
    ...
    if ($uploadImageOne != 0 && $uploadImagetwo != 0 && $uploadImagethree != 0 && $uploadImagefour != 0) {
      ...
      $product_price_current = $_POST['product_price'];
      $product_price_previous = $_POST['product_price'];
      ...
      $sqlInsertProductList = "INSERT INTO product_list ( category, name, keyword, brand, price_current, price_previous, promotion, description_short, description_long, specification, stock_value, image1, image2, image3, image4) VALUES ('$product_category', '$product_name', '$product_keyword', '$product_brand', '$product_price_current', '$product_price_previous', '$product_promotion', '$product_description_short', '$product_description_long', '$product_specification', '$product_stock_value', '$product_image1', '$product_image2', '$product_image3', '$product_image4')";
            ...
            <div class="row">
              <div class="col-lg-6 col-md-6 col-sm-6">
                <div class="checkout__form__input">
                  ...
                  <input type="text" name="product_name" required minlength="2" placeholder="Enter Product Name">
                </div>
              </div>
              <div class="col-lg-6 col-md-6 col-sm-6">
                <div class="checkout__form__input">
                  <p>Product Brand <span>*</span></p>
                  <input type="text" name="product_brand" required minlength="2" placeholder="Enter Product Brand">
                </div>
              </div>
              <div class="col-lg-6 col-md-6 col-sm-6">
                <div class="checkout__form__input">
                  <p>Product Price <span>*</span></p>
                  <input type="number" name="product_price" required minlength="2" placeholder="Enter Product Price">
                </div>
              </div>
              <div class="col-lg-6 col-md-6 col-sm-6">
                <div class="checkout__form__input">
                  <p>Product Keyword <span>*</span></p>
                  <input type="text" name="product_keyword" required minlength="5" placeholder="Enter Product Keyword">
                </div>
              </div>
              <div class="col-lg-6 col-md-6 col-sm-6">
                <div class="checkout__form__input">
                  <p>Promotion <span>*</span></p>
                  <input type="text" name="product_promotion" required minlength="2" placeholder="Enter Product Promotion">
                </div>
              </div>
              <div class="col-lg-6 col-md-6 col-sm-6">
                <div class="checkout__form__input">
                  <p>Short Description <span>*</span></p>
                  <input type="text" name="product_description_short" required minlength="2" placeholder="Enter Short Description">
                </div>
              </div>
              <div class="col-lg-6 col-md-6 col-sm-6">
                <div class="checkout__form__input">
                  <p>Long Description <span>*</span></p>
                  <input type="text" name="product_description_long" required minlength="2" placeholder="Enter Long Description">
                </div>
              </div>
              <div class="col-lg-6 col-md-6 col-sm-6">
                <div class="checkout__form__input">
                  <p>Product Specification <span>*</span></p>
                  <input type="text" name="product_specification" required minlength="2" placeholder="Enter Product Specification">
                </div>
              </div>
              <div class="col-lg-6 col-md-6 col-sm-6">
                <div class="checkout__form__input">
              ...
              <div class="col-lg-6 col-md-6 col-sm-6">
                <div class="margin-top-1">
                  ...
                  <input type="file" name="product_image4" id="product_image4" required>
                </div>
              </div>
